        ...
        | Ok schema ->
                ...
                let packageReferences =
                    ...
                    |> List.append
                        (seq {
                            ...
                            XElement.ofStringName("PackageReference",
                                    XAttribute.ofStringName("Include", "Fable.SimpleJson"),
                                    XAttribute.ofStringName("Version", "3.19.0"))
                        } |> Seq.toList)

                let projectDocument = CodeGen.generateProjectDocument packageReferences files None
            ...
            | OutputTarget.FSharp ->
                ...
                let packageReferences =
                    ...
                    |> List.append
                        (XElement.ofStringName("PackageReference",
                            XAttribute.ofStringName("Include", "Fable.Remoting.Json"),
                            XAttribute.ofStringName("Version", "2.14.0"))
                         |> List.singleton)
                let projectDocument = CodeGen.generateProjectDocument packageReferences files None
                File.WriteAllText(projectPath, projectDocument.ToString())
                    ...
                    |> List.append
                        (seq {
                            XElement.ofStringName("PackageReference",
                                ...
                                XAttribute.ofStringName("Version", "2.14.0"))
                            XElement.ofStringName("PackageReference",
                                XAttribute.ofStringName("Include", $"..\shared\{config.project}.Shared.fsproj"))
                        } |> Seq.toList)
                let projectDocument = CodeGen.generateProjectDocument packageReferences files config.copyLocalLockFileAssemblies
